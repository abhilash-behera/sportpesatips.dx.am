...
<div class="container"  style="  border:solid white 2px; border-radius:10px;  background:rgba(255,255,255,0.7); padding:8px;">
	...
	<script>
		document.getElementById("tomorrows-vip").style.color="black";
		document.getElementById("tomorrows-vip").style.fontWeight="bold";
		document.getElementById("tomorrows-vip").style.fontSize="1.1em";
	</script>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6">
				<center><h3>POST Tomorrow's VIP</h3></center>
				<form id="vip_gamepost" action="" method="post" >
					<div class="col-sm-5" >
						TIME:
			...
			<div class="col-sm-12 col-md-6 col-lg-6 " id="games" >
				<center><h3>Tomorrow's VIP</h3></center>
				<?php
...
if (date("H") == '23' || date("H") == '22' || date("H") == '21') {
    ...
    $query = "SELECT * FROM vip_games WHERE date = DATE_ADD(CURDATE(), INTERVAL 1 DAY) ORDER BY date desc,time desc limit 30 ";
}
