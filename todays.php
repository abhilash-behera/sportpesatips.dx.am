...
<div class="container"  style="  border:solid white 2px; border-radius:10px;  background:rgba(255,255,255,0.7); padding:8px;">
	...
	<script>
		document.getElementById("todays").style.color="black";
		document.getElementById("todays").style.fontWeight="bold";
		document.getElementById("todays").style.fontSize="1.1em";
	</script>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6">
				<center><h3>POST Today's Game</h3></center>
