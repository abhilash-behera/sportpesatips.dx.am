...
<div class="container"  style="  border:solid white 2px; border-radius:10px;  background:rgba(255,255,255,0.7); padding:8px;">
	...
	<script>
		document.getElementById("todays-vip").style.color="black";
		document.getElementById("todays-vip").style.fontWeight="bold";
		document.getElementById("todays-vip").style.fontSize="1.1em";
	</script>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6">
				<center><h3>POST Today's VIP</h3></center>
			...
			<div class="col-sm-12 col-md-6 col-lg-6 " id="games" >
				<center><h3>Today's VIP</h3></center>
				<?php
					...
					while ($gamedetails = $games->fetch_array()) {
						...
						if ($gamedetails['status'] == "upcoming") {
							...
							echo '
											<table border=0 width=100% style="font-size:15px;font-weight:bold;">
